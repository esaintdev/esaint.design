      ...
      <div className="container">
        ...
        <div className="bg-zinc-800/50 p-7 rounded-2xl md:p-12 reveal-up ">
          <p className="text-zinc-300 mb-4 md:mb-8 md:text-xl md:max-w-[60ch] ">
            Welcome! I&apos;m Esaint, a professional graphic designer with a knack
            for crafting visually stunning and highly functional designs.
            Combining creativity and technical expertise. I transform your
            vision into digital masterpiece that excels in appearance.
